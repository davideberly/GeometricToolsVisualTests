...
void TriangulationECWindow2::OnDisplay()
{
    ...
    std::size_t i{}, i0{}, i1{}, numPositions{};
    ...
    {
    case 0:
        numPositions = mPositions.size();
        for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
        {
            x0 = static_cast<std::int32_t>(mPositions[i0][0]);
            y0 = static_cast<std::int32_t>(mPositions[i0][1]);
            x1 = static_cast<std::int32_t>(mPositions[i1][0]);
            y1 = static_cast<std::int32_t>(mPositions[i1][1]);
            DrawLine(x0, y0, x1, y1, 0xFF000000);
        }
        break;
    case 1:
        numPositions = mOuter.size();
        for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
        {
            x0 = static_cast<std::int32_t>(mPositions[mOuter[i0]][0]);
            y0 = static_cast<std::int32_t>(mPositions[mOuter[i0]][1]);
            x1 = static_cast<std::int32_t>(mPositions[mOuter[i1]][0]);
            y1 = static_cast<std::int32_t>(mPositions[mOuter[i1]][1]);
            DrawLine(x0, y0, x1, y1, 0xFF000000);
        }
        break;
    case 2:
        ...
        numPositions = mInner0.size();
        for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
        {
            x0 = static_cast<std::int32_t>(mPositions[mInner0[i0]][0]);
            y0 = static_cast<std::int32_t>(mPositions[mInner0[i0]][1]);
            x1 = static_cast<std::int32_t>(mPositions[mInner0[i1]][0]);
            y1 = static_cast<std::int32_t>(mPositions[mInner0[i1]][1]);
            DrawLine(x0, y0, x1, y1, 0xFF000000);
        }
        break;
    ...
    case 3:
        ...
        numPositions = mInner1.size();
        for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
        {
            x0 = static_cast<std::int32_t>(mPositions[mInner1[i0]][0]);
            y0 = static_cast<std::int32_t>(mPositions[mInner1[i0]][1]);
            x1 = static_cast<std::int32_t>(mPositions[mInner1[i1]][0]);
            y1 = static_cast<std::int32_t>(mPositions[mInner1[i1]][1]);
            DrawLine(x0, y0, x1, y1, 0xFF000000);
        }
        break;
    ...
    case 4:
    {
        ...
        while (treeQueue.size() > 0)
        {
            ...
            treeQueue.pop();
            numPositions = tree->polygon.size();
            std::size_t const* indices = tree->polygon.data();
            for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
            {
                x0 = static_cast<std::int32_t>(mPositions[indices[i0]][0]);
                y0 = static_cast<std::int32_t>(mPositions[indices[i0]][1]);
                x1 = static_cast<std::int32_t>(mPositions[indices[i1]][0]);
                y1 = static_cast<std::int32_t>(mPositions[indices[i1]][1]);
                DrawLine(x0, y0, x1, y1, 0xFF000000);
            }
    ...
    case 10:
        ...
        numPositions = mInner2.size();
        for (i0 = numPositions - 1, i1 = 0; i1 < numPositions; i0 = i1++)
        {
            x0 = static_cast<std::int32_t>(mPositions[mInner2[i0]][0]);
            y0 = static_cast<std::int32_t>(mPositions[mInner2[i0]][1]);
            x1 = static_cast<std::int32_t>(mPositions[mInner2[i1]][0]);
            y1 = static_cast<std::int32_t>(mPositions[mInner2[i1]][1]);
            DrawLine(x0, y0, x1, y1, 0xFF000000);
        }
        break;
    }
    ...
    {
        DrawFloodFill4(static_cast<std::int32_t>(seed[0]), static_cast<std::int32_t>(seed[1]),
    ...
    for (auto const& tri : mTriangles)
    {
        ...
        x0 = static_cast<std::int32_t>(mPositions[v0][0]);
        y0 = static_cast<std::int32_t>(mPositions[v0][1]);
        x1 = static_cast<std::int32_t>(mPositions[v1][0]);
        y1 = static_cast<std::int32_t>(mPositions[v1][1]);
        DrawLine(x0, y0, x1, y1, 0xFF000000);

        x0 = static_cast<std::int32_t>(mPositions[v1][0]);
        y0 = static_cast<std::int32_t>(mPositions[v1][1]);
        x1 = static_cast<std::int32_t>(mPositions[v2][0]);
        y1 = static_cast<std::int32_t>(mPositions[v2][1]);
        DrawLine(x0, y0, x1, y1, 0xFF000000);

        x0 = static_cast<std::int32_t>(mPositions[v2][0]);
        y0 = static_cast<std::int32_t>(mPositions[v2][1]);
        x1 = static_cast<std::int32_t>(mPositions[v0][0]);
        y1 = static_cast<std::int32_t>(mPositions[v0][1]);
        DrawLine(x0, y0, x1, y1, 0xFF000000);
    }
...
bool TriangulationECWindow2::OnCharPress(std::uint8_t key, std::int32_t x, std::int32_t y)
{
    switch (key)
    {
    case '0':
...
void TriangulationECWindow2::FourBoxesThreeNested(std::size_t i0, std::size_t i1, std::size_t i2)
{
    ClearAll();
    mExample = 5;
