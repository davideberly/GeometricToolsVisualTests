...
void IntersectCylindersWindow3::CreateScene()
{
    ...
    mCylinder[0].center = { 0.0f, 0.0f, 0.0f };
    mCylinder[0].direction = { 0.0f, 0.0f, 1.0f };
    mCylinder[0].radius = 1.0f;
    mCylinder[0].height = 2.0f;

    mCylinder[1].center = { 4.0f, 0.0f, 0.0f };
    mCylinder[1].direction = { 0.0f, 0.0f, 1.0f };
...
{
    mCylinder[mMotionObject].center[direction] += delta;
...
void IntersectCylindersWindow3::Rotate(int32_t direction, float delta)
{
    ...
    cylinder.direction = cylinderBasis.GetCol(2);
...
void IntersectCylindersWindow3::UpdateCylinderMesh()
{
    ...
    {
        target[i] = cylinder.center + cylinderBasis * source[i];
    }
