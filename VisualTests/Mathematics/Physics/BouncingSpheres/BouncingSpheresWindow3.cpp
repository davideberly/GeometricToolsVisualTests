...
bool BouncingSpheresWindow3::OnCharPress(std::uint8_t key, std::int32_t x, std::int32_t y)
{
    switch (key)
    {
    case 'w':
...
bool BouncingSpheresWindow3::SetEnvironment()
{
    ...
    mEnvironment.Insert(path + "GTL/VisualTests/Mathematics/Physics/BouncingSpheres/Data/");
