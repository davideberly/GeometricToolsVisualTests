...
void ApproximateEllipsoid3Window3::CreateScene()
{
    ...
    ComputeOrthonormalBasis(1, mTrueEllipsoid.axis[0], mTrueEllipsoid.axis[1], mTrueEllipsoid.axis[2]);
    ...
    ApprEllipsoid3<float>::Fit(points, 1024, 1024, false, mApprEllipsoid);
